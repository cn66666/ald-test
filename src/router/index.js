  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: '/admin/business/doneOrderList',
          name: 'doneOrderList',
          meta: { title: '发货订单历史' },
          component: resolve => require(['../view/business/doneOrderList'], resolve),
        },
        {
          path: '/admin/business/orderInterceptList',
          name: 'orderInterceptList',
          meta: { title: '销售订单拦截' },
          component: resolve => require(['../view/business/orderInterceptList'], resolve),
        },
        {
          path: '/admin/business/orderExcessList',
          name: 'orderExcessList',
          meta: { title: '超额待处理' },
          component: resolve => require(['../view/business/orderExcessList'], resolve),
        },
        {
